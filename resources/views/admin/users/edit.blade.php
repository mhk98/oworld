        ...
        <div class="col-md-8">
            <div class="card my-2">
                <div class="card-head p-2 border-bottom">
                    <h6 class="card-title my-1">Edit User</h6>
                </div>
                <div class="card-body p-2">
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            <div class="mb-1">
                                <input type="text" name="first_name" placeholder="Enter First Name" value="{{ $user->first_name }}" class="form-control @error('first_name') is-invalid @enderror" required>
                                @error('first_name')
                        ...
                        <div class="col-6">
                            <div class="mb-1">
                                <input type="text" name="last_name" placeholder="Enter Last Name" value="{{ $user->last_name }}" class="form-control @error('last_name') is-invalid @enderror" required>
                                @error('last_name')
                                <span class="invalid-feedback text-warning" role="alert">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $user->email }}" placeholder="Email Address" required>
                        @error('email')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ $user->phone }}" placeholder="Phone" required>
                        @error('phone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex">
                            ...
                            <select class="form-select me-2 @error('birth_day') is-invalid @enderror" id="daySelect" name="birth_day" required>
                                ...
                                @for ($i = 1; $i <= 31; $i++) <option value="{{ $i }}" {{ $user->birth_day == $i ? 'selected' : '' }}>{{ $i }}</option>
                                    @endfor
                            </select>
                            ...
                            <select class="form-select me-2 @error('birth_month') is-invalid @enderror" id="monthSelect" name="birth_month" required>
                                ...
                                <option value="{{ $monthNumber }}" {{ $user->birth_month == $monthNumber ? 'selected' : '' }}>{{ $monthName }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('business_type') is-invalid @enderror" name="business_type">
                            ...
                            <option value="product" {{ $user->business_type=='product' ? 'selected' : '' }}>
                                Product
                            </option>
                            <option value="service" {{ $user->business_type=='service' ? 'selected' : '' }}>
                                Service
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('role') is-invalid @enderror" name="role" required>
                            <option value="user" {{ (!$user->is_admin && !$user->is_merchant) ? 'selected' : '' }}>
                                User
                            </option>
                            <option value="merchant" {{ $user->is_merchant ? 'selected' : '' }}>
                                Merchant
                            </option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" name="status" required>
                            ...
                            <option value="suspend" {{ $user->status == 'suspend' ? 'selected' : '' }}>
                                Suspend
                            </option>
