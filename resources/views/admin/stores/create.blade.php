...
@section('title', 'Add Store | '.env('APP_NAME'))
@section('content')
...
<form action="{{ route('admin.stores.store') }}" method="post" enctype="multipart/form-data" id="addStoreForm">
    @csrf
    <div class="row g-3">
        <div class="col-md-9">
            <div class="card my-2">
                <div class="card-head p-2 border-bottom">
                    <h6 class="card-title my-1">Add New Store</h6>
                </div>
                <div class="card-body p-2">

                    <div class="mb-3">
                        <label class="form-label">Business Name <span class="text-danger">*</span></label>
                        <input type="text" name="business_name" class="form-control @error('business_name') is-invalid @enderror" id="business_name" value="{{ old('business_name') }}" placeholder="Enter Business Name" required>
                        @error('business_name')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('merchant_id') is-invalid @enderror" id="merchant" name="merchant_id" required>
                            ...
                            <option value="{{ $merchant->id }}" {{ old('merchant_id')==$merchant->id ? 'selected' : ''}}>{{ $merchant->first_name . ' ' . $merchant->last_name }}</option>
                            @endforeach
                            @endif
                        </select>
                        @error('merchant_id')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('business_type') is-invalid @enderror" name="business_type" required>
                            <option value="products_and_services" {{ old('business_type')=='products_and_services' ? 'selected' : '' }}>Products and Services</option>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="products" class="form-control" value="{{ old('products') }}" data-role="tagsinput">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="services" class="form-control" value="{{ old('services') }}" data-role="tagsinput">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('intro') is-invalid @enderror" name="intro" rows="4" required>{{ old('intro') }}</textarea>
                        @error('intro')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" value="{{ old('phone') }}" placeholder="Enter Phone Number" required>
                        @error('phone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="established_since" class="form-control @error('established_since') is-invalid @enderror" id="established_since" value="{{ old('established_since') }}" placeholder="Enter Establishment Year">
            ...
            <div class="card mb-2">
                ...
                <div class="card-body p-2">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="facebook" class="form-control @error('facebook') is-invalid @enderror" id="facebook" value="{{ old('facebook') }}" placeholder="Enter Facebook URL" required>
                        @error('facebook')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="twitter" class="form-control @error('twitter') is-invalid @enderror" id="twitter" value="{{ old('twitter') }}" placeholder="Enter Twitter URL">
                        @error('twitter')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="instagram" class="form-control @error('instagram') is-invalid @enderror" id="instagram" value="{{ old('instagram') }}" placeholder="Enter Instagram URL">
                        @error('instagram')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="linkedin" class="form-control @error('linkedin') is-invalid @enderror" id="linkedin" value="{{ old('linkedin') }}" placeholder="Enter LinkedIn URL">
                        @error('linkedin')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="website" class="form-control @error('website') is-invalid @enderror" id="website" value="{{ old('website') }}" placeholder="Enter Website URL">
                        @error('website')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="map_url" class="form-control @error('map_url') is-invalid @enderror" id="map_url" value="{{ old('map_url') }}" placeholder="Enter Map URL">
                        @error('map_url')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="card-body p-2">
                    ...
                    <div class="mb-3">
                        <select name="featured_post_type" class="form-select w-50">
                            <option value="menu" {{ old('featured_post_type') == 'menu' ? 'selected' : '' }}>Menu</option>
                            <option value="products_and_services" {{ old('featured_post_type') == 'products_and_services' ? 'selected' : '' }}>Products and Services</option>
                            <option value="packages" {{ old('featured_post_type') == 'packages' ? 'selected' : '' }}>Packages</option>
                        </select>
                ...
                <div class="card-body p-2">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>{{ $day }}</th>
                            <td>
                                <select class="form-control" name="{{ strtolower($day) }}_opening">
                                    @for ($i = 0; $i < 24; $i++) @php $time=sprintf('%02d:00', $i); @endphp <option value="{{ $time }}" @if(old(strtolower($day) . '_opening' )==$time) selected @endif>
                            ...
                            <td>
                                <select class="form-control" name="{{ strtolower($day) }}_closing">
                                    @for ($i = 0; $i < 24; $i++) @php $time=sprintf('%02d:00', $i); @endphp <option value="{{ $time }}" @if(old(strtolower($day) . '_opening' )==$time) selected @endif>
                                        {{ date('h:i A', strtotime($time)) }}
                                        </option>
                                        @endfor
                            ...
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="{{ strtolower($day) }}TwentyFourHours" name="{{ strtolower($day) }}_24h">
                                    <label class="form-check-label" for="{{ strtolower($day) }}TwentyFourHours">Open 24 Hours</label>
                                </div>
                            </td>
                            <td>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="{{ strtolower($day) }}Closed" name="{{ strtolower($day) }}_closed">
                ...
                <div class="card-body p-2">
                    <div class="image-box mb-1">
                        ...
                        <div class="image-box-preview">
                            <img id="profile_image" src="{{ asset('static/admin/images/default.jpg') }}" alt="Profile Image">
                        </div>
                    ...
                    <div class="image-box mb-1">
                        <label class="form-label">Cover Picture <span class="text-danger">*</span></label>
                        <div class="image-box-preview">
                            <img id="cover_image" src="{{ asset('static/admin/images/default.jpg') }}" alt="Cover Image">
                        </div>
                        <div class="image-box-select">
