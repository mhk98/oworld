        ...
        <div class="col-md-9">
            <div class="card my-2">
                <div class="card-head p-2 border-bottom">
                    <h6 class="card-title my-1">Add Category</h6>
                </div>
                ...
                <div class="card-body p-2">
                    <div class="image-box mb-1">
                        ...
                        <div class="image-box-preview">
                            <img id="icon_image" src="{{ asset('static/admin/images/default.jpg') }}" alt="Icon Image">
                        </div>
                    ...
                    <div class="image-box mb-1">
                        ...
                        <div class="image-box-preview">
                            <img id="desktop_hero_image" src="{{ asset('static/admin/images/default.jpg') }}" alt="Desktop Hero Image">
                        </div>
                        <div class="image-box-select">
                    ...
                    <div class="image-box mb-1">
                        ...
                        <div class="image-box-preview">
                            <img id="mobile_hero_image" src="{{ asset('static/admin/images/default.jpg') }}" alt="Mobile Hero Image">
                        </div>
                        <div class="image-box-select">
