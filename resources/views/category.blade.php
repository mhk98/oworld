...
<div class="category-banner">
    ...
    <img src="{{ asset('media/'.$mainCategory->desktop_hero_image) }}" class="img-fluid w-100 d-none d-md-block" alt="{{ $mainCategory->title }}">
    @endif

    @if($mainCategory->mobile_hero_image)
    <img src="{{ asset('media/'.$mainCategory->mobile_hero_image) }}" class="img-fluid w-100 d-block d-md-none" alt="{{ $mainCategory->title }}">
    @endif
</div>
...
<div class="categories d-flex align-items-start mt-3">
    ...
    <a href="{{ route('category', $categoryItem->slug) }}" class="text-center {{ request()->is('category/' . $categoryItem->slug) ? 'active' : '' }}">
...
<div class="sub-categories">
    <ul>
        ...
        <li><a href="{{ route('subCategory', ['mainCategory' => $subCategory->parentCategory->slug, 'subCategory' => $subCategory->slug]) }}">{{ $subCategory->title }}</a></li>
        @endforeach

        @if($mainCategory->id == '7' || $mainCategory->id == '8')
        <li><a href="{{ route('subCategory', ['mainCategory' => $mainCategory->slug, 'subCategory' => 'nutrition']) }}">Nutrition</a></li>
        @endif
    </ul>
</div>
@endif
...
@if(!request()->is('category/travel') && !request()->is('category/social-services'))
